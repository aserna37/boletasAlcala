<h1 class="text-center"><span class="badge rounded-pill bg-warning text-dark">Compradores</span></h1>
<hr>
<div class="row text-center">
    <div class="col-md-3 col-sm-12">
        <a type="button" class="btn btn-block btn-outline-danger" data-toggle="modal" data-target="#ModalnuevaPersonaC"><i class="fas fa-user-friends"></i> Nuevo Comprador</a>
    </div>
<br>
<br>
<div class="col-md-10 col-sm-12 mx-auto">
<div class="border p-3 animate__animated animate__fadeIn">
<table class="table table-sm" id="tablaCompradores">
  <thead>
    <tr>
...
<!-- NUEVO COMPRADOR -->
<div class="modal fade" id="ModalnuevaPersonaC" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form id="agregarPersonaC">
        ...
        <input class="form-control form-control-sm" type="text" name="vendedor" value="N" hidden>
        <input class="form-control form-control-sm" type="text" name="comprador" value="S" hidden>
...
<!-- ASIGNAR BOLETA -->
<div class="modal fade" id="ModalAsignarBoletaC" data-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="text" id="documentoComprador" hidden>
        <h5>Boletas Entregadas</h5>
        <hr>
        <div id="boletasCompradas" class="border border-danger"></div>
        <div>
          <br>
